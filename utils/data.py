...
class PDBProtein(object):
    ...
    def query_residues_centers(self, centers, radius, criterion="center_of_mass"):
        ...
        for res in selected_residues:
            selected_atom_serial += [
                self.atoms[a_idx]["atom_id"] for a_idx in res["atoms"]
            ]
...
class ProteinLigandData(Data):
    ...
    def __inc__(self, key, value, *args, **kwargs):
        ...
        # for decomp
            ...
            return (
                self["num_arms"] + 1
            )  # though there is no scaffold, decomp num atoms / centers still occupy 1 dim
            ...
            return self["ligand_atom_mask"].size(
                0
            )  # only set ligand atom mask during sampling
        else:
